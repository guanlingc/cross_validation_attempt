...
class KNN_Model:
    '''This class creates a KNN object 
    Parameter:
    neighbor_value: amount of neighbors
    weights_value: which weight to choose 
    which_metric: which metric to choose
    '''
    def __init__(self, neighbor_value, weights_value, which_metric):
        self.model = KNeighborsClassifier(n_neighbors = neighbor_value, weights = weights_value,  metric = which_metric)
